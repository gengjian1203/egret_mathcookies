...
var Menu = (function (_super) {
    ...
    Menu.prototype.initMainUI = function () {
        // 获取屏幕大小（未认证）
    ...
    // 广告
    Menu.prototype.switchToDownloadPage = function () {
    ...
    // 游戏开始
    Menu.prototype.onGameStart = function () {
    ...
    // 游戏关于信息显示
    Menu.prototype.onGameAboutShow = function () {
        this.strShow.alpha = 1.0;
    };

    // 游戏关于信息隐藏
    Menu.prototype.onGameAboutHide = function () {
        this.strShow.alpha = 0.0;
    };
    return Menu;
